...
local county : number = 0
local mandela : boolean = false
...
local InvisibleWalls : Folder = game:GetService("Workspace").Filter.InvisibleWalls
local LocationPoints : Folder = game:GetService("Workspace").Filter.LocationPoints
...
local function CreateGui()
	...
	Main.Position = UDim2.new(0.42668736, 0, 0.038787879, 0)
	Main.Size = UDim2.new(0.140418932, 0, 0.117575757, 0)
	Main.Visible = false
	Main.ZIndex = 10000
	Main.Active = true
	Main.Draggable = true
	...
	Time.Position = UDim2.new(0, 0, 0.100000001, 0)
	Time.Size = UDim2.new(1, 0, 0.515463889, 0)
	...
	UIAspectRatioConstraint.Parent = Power
	UIAspectRatioConstraint.AspectRatio = 7.023
	...
	UIAspectRatioConstraint_2.Parent = PowerS
	UIAspectRatioConstraint_2.AspectRatio = 7.023

	UIAspectRatioConstraint_3.Parent = Time
	UIAspectRatioConstraint_3.AspectRatio = 3.620
	...
	TimeS.Position = UDim2.new(0.0250000004, 0, 0.150000006, 0)
	TimeS.Size = UDim2.new(1, 0, 0.515463889, 0)
	TimeS.ZIndex = 0
	...
	UIAspectRatioConstraint_4.Parent = TimeS
	UIAspectRatioConstraint_4.AspectRatio = 3.620

	UIAspectRatioConstraint_5.Parent = Main
	UIAspectRatioConstraint_5.AspectRatio = 1.866

	UICorner.CornerRadius = UDim.new(0.100000001, 0)
	UICorner.Parent = Main

	UIAspectRatioConstraint_6.Parent = RobloxTimeHandler
	UIAspectRatioConstraint_6.AspectRatio = 1.562
...
Infinite Stamina
--]]--]]--]]--]]--]]--]]--]]--]]--]]--]]
local function INFINITESTAMINA(bool : boolean)
	if bool == true then
...
FullBright
--]]--]]--]]--]]--]]--]]--]]--]]--]]--]]
local function FULLBRIGHT(bool : boolean)
	if bool == true then
		if BrightLoop then
...
No Fog
--]]--]]--]]--]]--]]--]]--]]--]]--]]--]]
local function NOFOG(bool : boolean)
	if bool == true then
		if FogLoop then
			FogLoop:Disconnect()
		end
...
No Map Borders
--]]--]]--]]--]]--]]--]]--]]--]]--]]--]]
local function NOBORDER(bool : boolean)
	if bool == true then
...
local function RAKESP(bool : boolean)
	if bool == true then
		for _, v in pairs(workspace:GetChildren()) do
			if v.Name == 'Rake' then
...
Places ESP
--]]--]]--]]--]]--]]--]]--]]--]]--]]--]]
local function PLACESP(bool : boolean)
	if bool == true then
...
local function FLARESP(bool : boolean)	
	if bool == true then
		if workspace:FindFirstChild('FlareGunPickUp') then
			if workspace.FlareGunPickUp:FindFirstChild('FlareGun')  then
...
local function SCRAPESP(bool : boolean)
	if bool == true then
		for _, v in pairs(ScrapSpawns:GetDescendants()) do
			if v.Name == "Scrap" then
				if v:FindFirstChildWhichIsA('BillboardGui') then
...
local function ChangeTexting(text : string, parent : GuiObject)
	parent.Text = text
end
...
local function TIMERGUI(bool : boolean)
	if bool == true then
		Main2.Visible =  true
	else
		Main2.Visible = false
...
Players ESP
--]]--]]--]]--]]--]]--]]--]]--]]--]]--]]
local function EnableESP(char, bool : boolean)
	local Humanoid : Humanoid = char:WaitForChild("Humanoid", 5)
	if Humanoid then
		if bool == true then
...
local function PLAYERESP(bool : boolean)
	if bool == true then
...
local function CRATESP(bool : boolean)
	if bool == true then
...
-----------------
	...
	local CharSection = MainPaging:addSection("Character")
		--Infinite Stamina
		CharSection:addToggle("Infinite Stamina", _G.Settings.InfBool, function(bool)
...
----------------
	...
	local Settingss = SettingsPaging:addSection("Settings")
		...
		Settingss:addKeybind("Toggle GUI Visibility", _G.Settings.KeyBinding, function()
			...
			_G.Settings.KeyBinding = keycode
			SaveSettings()
			print(keycode)
		end)
